...
public static class SeedDatabase
{
    public static async void Initialize(IApplicationBuilder app)
    {
        ...
        {
            var customer = new AppUser { Name = "Cagdas Bilgin", UserName = "caggdas", Email = "cagdasbilgin1@gmail.com" };
            var admin = new AppUser { Name = "Acun Ilicali", UserName = "acunn", Email = "acunn@gmail.com" };
